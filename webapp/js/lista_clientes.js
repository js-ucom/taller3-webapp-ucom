function listaClientes() {
    axios
      ...
      .then(function (res) {
        ...
        res.data.forEach(function (value, index) {
            ...
            cell1.innerHTML = "" + value.id_cliente;
            cell2.innerHTML = "" + value.nombre;
            cell3.innerHTML = "" + value.apellido;
            cell4.innerHTML = "" + value.direccion;
            cell5.innerHTML = "" + value.telefono
          });
  ...
  var tabla = document.getElementById("tblListaClientes");
